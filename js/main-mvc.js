...
MVC.view.prototype.drawGameScreen = function (enemyY, playerY, playerScore, enemyScore, playerWidth, playerHeight, ballX, ballY, ballSize) {
    this._canvasContext.font = "20px Georgia";
    ...
    this._canvasContext.fillText(enemyScore,  this._canvas.width - 100, 100)
}
...
MVC.controller.prototype.update = function () {
    ...
    if (this._ball.getBallX() < 0) {
        if (this._ball.getBallY() > this._player.getY() && this._ball.getBallY() < this._player.getY() + this._player.getPlayerHeight()) {
            ...
            this._ball.resetBall(this._view.getCanvas().width,this._view.getCanvas().height);
        }
    }
...
window.onload = function () {
    ...
    controller._view.getCanvas().addEventListener('mousemove', function (e) {
        var temp = this;
        controller._player.setY(e.clientY - controller._player.getPlayerHeight() * 2);
    });
}
